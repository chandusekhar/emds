namespace Nsim
{
    ...
    internal class x3e14c21047440e17<T> : ITrainerDecoratorDescriptor where T: ITrainerDecorator
    {
        ...
        public x3e14c21047440e17(string title)
        {
            // This item is obfuscated and can not be translated.
        }

        public ITrainerDecorator GetDecorator()
        {
            return (this._x48a150aa547655ec.GetConstructors().First<ConstructorInfo>().Invoke(null) as ITrainerDecorator);
        }

        public ITrainerDecorator GetDecorator(XElement config)
        {
            ITrainerDecorator decorator = this.GetDecorator();
