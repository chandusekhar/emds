namespace emds.MyNsim4
{
    ...
    public class LinearScale //: IConfigurable, IDataProcessor
    {
        ...
        //        if ((((uint) flag.GetInt()) + ((uint) num2)) >= 0)
        //        {
        //            goto Label_0224;
        //        }
        //    }
        //if ((((uint)flag.GetInt()) - ((uint)num3)) <= uint.MaxValue)
        //    {
        //        goto Label_00D3;
        //    }
        //    goto Label_015E;
        ...
        //        }
        //        num3++;
        //        if ((((uint)flag.GetInt()) - ((uint)num5)) <= uint.MaxValue)
        //        {
        //            goto Label_0286;
        //        }
        //    }
        ...
        //if ((((uint)num3) + ((uint)flag.GetInt())) >= 0)
        //    {
        //        if (flag)
        //        {
        //            goto Label_0542;
        ...
        //    else
        //    {
        //        if ((((uint)flag.GetInt()) + ((uint)flag.GetInt())) <= uint.MaxValue)
        //        {
        //            goto Label_0592;
        //        }
        ...
        public BasicMLDataSet ProcessDataSet(BasicMLDataSet dataToProcess)
        {
            ...
            Label_003E:
                ...
                if ((((uint)flag.GetInt()) - ((uint)flag.GetInt())) < 0)
                {
                    goto Label_003E;
                }
            }
        ...
        public IMLData ProcessIdealVector(IMLData row)
        {
            ...
            while (num < row.Count)
            {
                ...
                if ((((uint)flag.GetInt()) - ((uint)num)) > uint.MaxValue)
                {
                    break;
                }
                num++;
        ...
        public IMLData ProcessInputVector(IMLData row)
        {
            ...
            bool flag = false;
            BasicMLData data = new BasicMLData(row.Count);
            if ((((uint)num) - ((uint)flag.GetInt())) >= 0)
            {
                num = 0;
            }
            while (true)
        ...
        /// <summary>
        /// "Кодирование" идеального значения
        /// </summary>
        /// <param name="xbcea506a33cf9111"></param>
        ...
        /// <summary>
        /// обработка входного вектора. "кодирование" значения
        /// </summary>
        /// <param name="xbcea506a33cf9111">"кодируемое" значение</param>
        /// <param name="xc0c4c459c6ccbd00">индекс значения</param>
        /// <returns></returns>
        ...
        public XElement Xml
        {
            ...
            //    if (0 == 0)
            //    {
            //        if ((((uint)flag.GetInt()) + ((uint)num)) >= 0)
            //        {
            //            goto Label_0086;
            //        }
            //        goto Label_01F5;
            ...
            //    goto Label_008F;
            //Label_00E5:
            //    if (((uint)flag.GetInt()) <= uint.MaxValue)
            //    {
            //        while (true)
            //        {
            //            if (0 != 0)
